...
- **Reopening a completed service item now keeps its old deadline** if you leave the days field blank, rather than clearing it. To reopen with no deadline, reopen first and then clear it with the deadline control.
