...
const FIXTURES: Fixture[] = [
  ...
  { name: "logon after marking does NOT flip to deployed", expected: "READY_TO_DEPLOY", markedReadyAt: JAN, lastLogonAt: JUN, lastLogonUser: "a@b.mil" },
  { name: "open receipt still overrides a marking", expected: "DEPLOYED", markedReadyAt: JUN, onOpenReceipt: true, lastLogonAt: JAN, lastLogonUser: "a@b.mil" },
