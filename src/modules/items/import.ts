...
export function planImport(
  ...
  for (const c of candidates) {
    ...
    if (match) {
      ...
      // The rename flag rides with the SILENT fields, deliberately. It is the
      // importer's note to a human ("this device needs renaming in Intune"),
      // not a custody fact, so it must never appear in the item's edit history
      // — the same reasoning that keeps MDM telemetry out of it.
      //
